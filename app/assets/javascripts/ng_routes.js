...
config(['$routeProvider', function($routeProvider) {
  ...
  $routeProvider.when('/view6',  {templateUrl: 'commodities', controller: 'MyCtrl6'});    //Commodities-1
  ...
  $routeProvider.when('/view9',  {templateUrl: 'commodities', controller: 'MyCtrl6'});    //Commodities-2
